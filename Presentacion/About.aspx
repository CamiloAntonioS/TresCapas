		...
		<div style="width: 435px">
			...
			<table style="border: 2px solid #cccccc;">
				<tr style="background-color: white; color: black;">
					<th colspan="3">AGREGAR VEHICULOS<br />
                    </th>
				</tr>
				<tr>
					<td>PATENTE: </td>
				...
				<tr>
					<td></td>
					<td>
						<asp:Button ID="btnEnviar" runat="server" Text="Guardar" OnClick="Agregar" Width="105px" />
						<br />
                        <br />
						<asp:Button ID="btnBuscar" runat="server" Text="Buscar Patente" OnClick="BuscarPatente" Width="106px" />
						<br />
                        <br />
						<asp:Button ID="btnBuscarRut" runat="server" Text="Buscar Rut" OnClick="BuscarRut" />
					</td>
					<td>
						<asp:Button ID="Load" runat="server" Text="Mostrar" OnClick="gvMostrar" Width="82px" />
						<br />
                        <br />
